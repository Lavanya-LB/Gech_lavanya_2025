...
public class HomeController {
	...
	public String getStudent(@RequestParam("id") Long id, Model model) {
	    ...
	    return "edit-student"; // template name should match exactly
	}
	
	@PostMapping("/edit-student")
	public String updateStudent(@ModelAttribute StudentDTO studentDTO, @RequestParam("id") Long id) { 
